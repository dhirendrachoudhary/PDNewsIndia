    <ul class="mom-social-icons">
        ...
        <?php if(mom_option('instagram_url') != '') { ?>
                <li class="instagram"><a target="_blank" class="vector_icon" href="<?php echo mom_option('instagram_url'); ?>"><i class="fa-icon-instagram"></i></a></li>
        <?php } ?>

        <?php if(mom_option('pinterest_url') != '') { ?>
                <li class="pinterest"><a target="_blank" class="vector_icon" href="<?php echo mom_option('pinterest_url'); ?>"><i class="fa-icon-pinterest"></i></a></li>
        <?php } ?>
