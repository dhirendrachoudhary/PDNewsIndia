...
/* ==========================================================================
                 	Scripts and Style
========================================================================== */
if (! function_exists('mom_scripts_styles')) {
...
function mom_scripts_styles() {
	...
	wp_register_script( 'sharrre', get_template_directory_uri() . '/js/jquery.sharrre.min.js', array('jquery'), '1.0', true );
...
if (! function_exists('mom_header_scripts')) {
...
/*----------------------------
    predefined Colors
 ----------------------------*/
if (! function_exists('mom_predefined_colors')) {
add_action( 'wp_enqueue_scripts', 'mom_predefined_colors', 30);
...
/* ==========================================================================
                 	Admin scripts
========================================================================== */
if (! function_exists('mom_admin_scripts')) {
...
/* ==========================================================================
                 	Post image
========================================================================== */
if (! function_exists('mom_post_image')) {
// Momizat Get Images
...
/* ==========================================================================
                 	First Image
========================================================================== */
if (! function_exists('mom_get_first_image')) {
...
/* ==========================================================================
                 	Full image element
========================================================================== */
if (! function_exists('mom_post_image_full')) {
...
//Descover Vimeo
if (! function_exists('mom_discoverVimeo')) {
...
// date format
if (! function_exists('get_mom_date_format')) {
...
if (! function_exists('mom_date_format')) {
...
//next & prev post
if (! function_exists('mom_post_nav')) {
...
?>
			...
			?>
			<div class="post-img">
                            <a href="<?php echo get_permalink($prev_post->ID); ?>"><img src="<?php echo mom_post_image('small-wide', $prev_post->ID); ?>" data-hidpi="<?php echo mom_post_image('small-wide-hd', $prev_post->ID); ?>" alt="<?php echo $post->post_title ?>"></a>
                        </div>
			<?php } ?>
		...
		?>
			...
			?>
			<div class="post-img">
                            <a href="<?php echo get_permalink($next_post->ID); ?>"><img src="<?php echo mom_post_image('small-wide', $next_post->ID); ?>" data-hidpi="<?php echo mom_post_image('small-wide-hd', $next_post->ID); ?>" alt="<?php echo $post->post_title ?>"></a>
                        </div>
			<?php } ?>
                        <div class="details <?php echo $is_img; ?>">
...
/* ==========================================================================
                 	Author Box
========================================================================== */
if (! function_exists('mom_author_box')) {
...
<?php if ($style != 'min') { ?>
<?php if ($title != false) { ?>
<h2 class="single-title"><?php _e('About the author', 'theme'); ?></h2>
<?php } ?>
<?php } ?>
            <div class="base-box single-box about-the-author">
                <div class="author_avatar"><?php echo get_avatar( get_the_author_meta( 'user_email', $id ), '80' ); ?></div>
                <div class="author_desc">
                    <h3 calss="vcard author"><span class="fn"><a href="<?php echo get_author_posts_url( $uid ); ?>"><?php the_author_meta( 'display_name', $id ); ?></a></span> <?php if ($style == 'min') { if (mom_option('author_np') == 1) { ?><span class="articles-count"><?php _e('Articles', 'theme'); ?> <?php echo number_format_i18n( get_the_author_posts() ); ?><?php } } ?> </span></h3>
        <p>
		<?php
		 if(function_exists('icl_register_string')) {
                icl_register_string('author', 'description', the_author_meta('description', $id));
                echo icl_t('author', 'description', the_author_meta('description', $id));
                } else {
...
global $post;
	?>
                <h2 class="single-title"><?php _e('Related Articles', 'theme'); ?></h2>
	...
	?>
   <?php if ($relatedby == 'tags' || $relatedby == 'both' ) { ?>
	    <?php
	    ...
	    ?>
	       ...
	       <li>
			<?php if (mom_post_image() != false) { ?>
                        <a href="<?php the_permalink(); ?>"><img src="<?php echo mom_post_image('related-posts'); ?>" data-hidpi="<?php echo mom_post_image('big-wide-img'); ?>" alt="<?php echo $post->post_title ?>"></a>
			<?php } ?>
                        <h4><a itemprop="name" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4>
                        <div class="mom-post-meta">
			<time datetime="<?php the_time('c'); ?>"><?php mom_date_format(); ?></time>
			</div>
                </li>
<?php endwhile; ?>
                <?php  else:  ?>
                ...
                <?php wp_reset_query(); ?>
                  <?php endif;?>
<?php } elseif ($relatedby == 'category' || $relatedby == 'both' ) { ?>
	    <?php
		global $post;
...
//breadcrumbs
if (! function_exists('mom_breadcrumb')) {
...
if (! function_exists('mom_load_dashicons')) {
function mom_load_dashicons() {
	wp_enqueue_style( 'dashicons' );
}
}
//author meta
if (! function_exists('mom_user_contactmethods')) {
...
if (! function_exists('mom_extra_profile_fields')) {
...
if (! function_exists('mom_save_extra_profile_fields')) {
...
// posts format
if (! function_exists('mom_single_post_format')) {
...
<?php if ($format == 'video' || $article_type == 'video' ) { ?>
                                     <?php
                                      ...
                                      $extra = get_post_meta($id , $posts_st->get_the_id(), TRUE);
										...
										if (in_array('fullwidth',$classes)) {
	                                        $vi_width = '100%';
	                                        $vi_height = '581';
	                                        $shv_class = 'shv-fullwidth';
										}
					...
					if ($html5_poster == '') {
						$html5_poster = ' poster="'.get_post_meta($post->ID, 'mom_video_html_poster', true).'" ';
                                    ...
                                    <div class="video_frame">
                                      <iframe width="<?php echo $vi_width; ?>" height="<?php echo $vi_height; ?>" src="https://www.youtube.com/embed/<?php echo $video_id; ?>?<?php echo $e_autoplay; ?>" frameborder="0" allowfullscreen></iframe>
                                    </div><!--End Vido_frame-->
                                    <?php } elseif ($video_type == 'vimeo') { ?>
                                    <div class="video_frame">
                                        <iframe src="http://player.vimeo.com/video/<?php echo $video_id; ?>?<?php echo $e_autoplay; ?>title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff" width="<?php echo $vi_width; ?>" height="<?php echo $vi_height; ?>" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                                    </div><!--End Vido_frame-->
                                    <?php } elseif ($video_type == 'dailymotion') { ?>
                                    <div class="video_frame">
					<iframe frameborder="0" width="<?php echo $vi_width; ?>" height="<?php echo $vi_height; ?>" src="//www.dailymotion.com/embed/video/<?php echo $video_id; ?>?<?php echo $e_autoplay; ?>logo=0" allowfullscreen></iframe>
                                    </div><!--End Vido_frame-->
                                    ...
                                    <div class="video_frame <?php echo $shv_class; ?>">
...
<?php } elseif ($format == 'audio') { ?>
					...
					if ($audio_poster == '' && has_post_thumbnail($id)) {
					    $audio_poster = ' poster="'.mom_post_image('post_large_image').'"';
                                   ...
                                   <?php if(mom_post_image() != false) {?>
						<?php if ($HFI != 1) { ?>
						<img src="<?php echo mom_post_image('full'); ?>" alt="<?php echo $post->post_title ?>">
						<?php } ?>
                                   <?php } ?>
...
if (! function_exists('my_format_chat_content')) {
 ...
 *                Login Widget
   ========================================================================== */
if (! function_exists('mom_login_widget')) {
...
?>
					...
					<div class="mom-submit-wrapper">
						...
						<label for="rememberme"><i class="fa-icon-ok"></i><?php _e('Remember Me', 'theme'); ?></label>
				...
				<div class="lw-user-info">
					...
					<a href="<?php echo wp_logout_url(home_url()); ?>" class="button"><?php _e('Log Out', 'theme'); ?></a>
				</div>
...
if (! function_exists('mom_login_form')) {
...
if (! function_exists('mom_register_form')) {
...
if (! function_exists('mom_registration_process_hook')) {
...
if (! function_exists('mom_remove_x_pingback')) {
