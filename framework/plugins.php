...
$logos = MOM_ADDON_URI . '/assets/images/';
	$plugins = array(
		...
		array(
			...
			'slug' 		=> 'contact-form-7',
			'required' 	=> false,
			'logo'				=> 'http://ps.w.org/contact-form-7/assets/icon-256x256.png?rev=1179533',
		...
		array(
			...
			'slug' 		=> 'bbpress',
			'required' 	=> false,
			'logo'				=> 'http://ps.w.org/bbpress/assets/icon.svg',
			'author'			=> 'The bbPress Community',
			'desc'				=> 'bbPress is forum software, made the WordPress way.',
			'type'				=> 'plugin',
		),
		...
		array(
			...
			'slug'     				=> 'js_composer',
			'source'   				=> mom_plugin_url('js_composer_gn'),
			'required' 				=> true,
			'version' 				=> mom_plugin_version('js_composer_gn'),
		...
		array(
			...
			'slug'     				=> 'revslider',
			'source'   				=> mom_plugin_url('revslider'),
			'required' 				=> false,
			'version' 				=> mom_plugin_version('revslider'),
			'require_activation' 		=> true,
			'force_activation' 		=> false,
			'force_deactivation' 	=> false,
			'external_url' 			=> '',
		...
		array(
			'name'     				=> 'Goodnews Shortcodes editor',
			'slug'     				=> 'goodnews-shortcode-editor',
			'source'   				=> mom_plugin_url('goodnews-shortcode-editor'),
			'required' 				=> false,
			'version' 				=> mom_plugin_version('goodnews-shortcode-editor'),
			'external_url' 			=> '',
			'logo'				=> $logos . 'goodnews-shortcoode.png',
			'author'			=> 'Momizat',
			'desc'				=> 'simple tools add theme shortcodes to editor in both visual and text mode',
			'type'				=> 'addon',
		),
