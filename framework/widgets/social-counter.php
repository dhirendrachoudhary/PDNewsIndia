...
*/
		parent::__construct('momizatSocialCounter',__('Momizat - Social Counter','theme'),$widget_ops);
                            ...
                            <ul>
                                ...
                                <li class="msc-item msc-facebook">
                                    ...
                                    <div class="sc-head">
                                        ...
                                        <span><?php _e('facebook', 'theme'); ?></span>
                                    </div>
                                    </a>
                                    <div class="sc-count">
                                ...
                                <li class="msc-item msc-twitter">
                                    ...
                                    <div class="sc-head">
                                        ...
                                        <span><?php _e('twitter', 'theme'); ?></span>
                                    </div>
                                    </a>
                                    <div class="sc-count">
                                ...
                                <li class="msc-item msc-dribbble">
                                    <a href="<?php echo mom_sc_dribbble($dribbble, 'link'); ?>" target="_blank">
                                        ...
                                        <span><?php _e('dribbble', 'theme'); ?></span>
                                    </div>
                                    </a>
                                    <div class="sc-count">
                                ...
                                <li class="msc-item msc-youtube">
                                    ...
                                    <div class="sc-head">
                                        ...
                                        <span><?php _e('Youtube', 'theme'); ?></span>
                                    </div>
                                    </a>
                                    <div class="sc-count">
                                ...
                                <li class="msc-item msc-pinterest">
                                    ...
                                    <div class="sc-head">
                                        ...
                                        <span><?php _e('pinterest', 'theme'); ?></span>
                                    </div>
                                    </a>
                                    <div class="sc-count">
                                ...
                                <li class="msc-item msc-instagram">
                                    <a href="<?php echo esc_url('http://instagram.com/'.$instagram); ?>" target="_blank">
                                    <div class="sc-head">
                                        <i class="fa-icon-instagram"></i>
                                        <span><?php _e('instagram', 'theme'); ?></span>
                                    </div>
				    </a>
                                    <div class="sc-count">
                                ...
                                <li class="msc-item msc-soundcloud">
                                    ...
                                    <div class="sc-head">
                                        ...
                                        <span><?php _e('sound cloud', 'theme'); ?></span>
                                    </div>
                                    </a>
                                    <div class="sc-count">
				...
				<?php if ($behance != '') { ?>
                                <li class="msc-item msc-behance">
                                    ...
                                    <div class="sc-head">
                                        ...
                                        <span><?php _e('behance', 'theme'); ?></span>
                                    </div>
				    </a>
                                    <div class="sc-count">
                                ...
                                <li class="msc-item msc-delicious">
                                    ...
                                    <div class="sc-head">
                                        ...
                                        <span><?php _e('delicious', 'theme'); ?></span>
                                    </div>
				    </a>
                                    <div class="sc-count">
