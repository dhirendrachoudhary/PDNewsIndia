...
<div class="mom-video-widget">
	<?php if($type == 'youtube') { ?>
	<iframe src="https://www.youtube.com/embed/<?php echo $id; ?>?rel=0" frameborder="0" allowfullscreen></iframe>
	<?php } elseif($type == 'vimeo') { ?>
	<iframe src="https://player.vimeo.com/video/<?php echo $id; ?>?title=0&amp;byline=0&amp;portrait=0&amp;color=ba0d16" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
	<?php } elseif($type == 'daily') { ?>
	<iframe frameborder="0" src="https://www.dailymotion.com/embed/video/<?php echo $id ?>?logo=0" allowfullscreen></iframe>
	<?php } ?>
</div>
<?php
