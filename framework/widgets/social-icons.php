		...
		<ul>
			<?php
				foreach( $icons as $icon ) {
					...
					switch ($icon) {
						case 'Facebook':
							echo '<li class="facebook"><a href="'.$url.'" target="_blank"><i class="fa-icon-facebook "></i></a></li>';
						break;
						case 'Twitter':
							echo '<li class="twitter"><a href="'.$url.'" target="_blank"><i class="fa-icon-twitter "></i></a></li>';
						break;
						case 'GooglePlus':
							echo '<li class="googleplus"><a href="'.$url.'" target="_blank"><i class="fa-icon-google-plus "></i></a></li>';
						break;
						case 'RSS':
							echo '<li class="rss"><a href="'.$url.'" target="_blank"><i class="fa-icon-rss "></i></a></li>';
						break;
						case 'Youtube':
							echo '<li class="youtube"><a href="'.$url.'" target="_blank"><i class="fa-icon-youtube "></i></a></li>';
						break;
						case 'Dribbble':
							echo '<li class="dribbble"><a href="'.$url.'" target="_blank"><i class="fa-icon-dribbble "></i></a></li>';
						break;
						case 'Vimeo':
							echo '<li class="vimeo"><a href="'.$url.'" target="_blank"><i class="momizat-icon-vimeo "></i></a></li>';
						break;
						case 'Pinterest':
							echo '<li class="pinterest"><a href="'.$url.'" target="_blank"><i class="fa-icon-pinterest "></i></a></li>';
						break;
						case 'Instagram':
							echo '<li class="instgram"><a href="'.$url.'" target="_blank"><i class="fa-icon-instagram "></i></a></li>';
						break;
						case 'Tumblr':
							echo '<li class="tumblr"><a href="'.$url.'" target="_blank"><i class="fa-icon-tumblr "></i></a></li>';
						break;
						case 'Linkedin':
							echo '<li class="linkedin"><a href="'.$url.'" target="_blank"><i class="fa-icon-linkedin "></i></a></li>';
						break;
						case 'SoundCloud':
							echo '<li class="soundcloud"><a href="'.$url.'" target="_blank"><i class="momizat-icon-soundcloud "></i></a></li>';
						break;
