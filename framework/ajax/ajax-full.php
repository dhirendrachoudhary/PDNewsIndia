...
function mom_nb_show_more() {
    ...
    $exclude_categories = $_POST['exclude_cats'];
    global $da;
...
?>
<?php
$posts_query = new WP_Query( array('s' =>$_POST['term'], 'post_type' => 'post', 'posts_per_page' => 5, 'post_status' => 'publish') );
...
?>
<?php
$pages_query = new WP_Query( array('s' =>$_POST['term'], 'post_type' => 'page', 'posts_per_page' => 5, 'post_status' => 'publish') );
