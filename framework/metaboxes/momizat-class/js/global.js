...
$('.mmg-item .mmmg-head').on('click', function(e) {
    if (e.target === this) {
        ...
        if (expand.hasClass('dashicons-arrow-down')) {
            expand.removeClass().addClass('dashicons dashicons-arrow-up');
        } else {
            expand.removeClass().addClass('dashicons dashicons-arrow-down');
        }
    }
});
