...
<span class="description html5_video hide"><?php _e('you can upload only one video but the unspported browsers/devices will play video in flash for more information <a href="http://mediaelementjs.com/#devices" target="_blank">click here</a> ', 'framework'); ?></span>
</p>
...
<span class="description html5_audio hide"><?php _e('you can upload only one audio but the unspported browsers/devices will play video in flash for more information <a href="http://mediaelementjs.com/#devices" target="_blank">click here</a> ', 'framework'); ?></span>
</p>
