...
wp_enqueue_script( 'momizat-mb-ads', get_template_directory_uri() . '/framework/e3lanat/js/e3lanat.js', array('jquery'), '1.0', true );
...
<div class="mti_options_wrap mti_custom_responsive hide">
    <div class="mti_option">
        <span><?php _e('Responsive ad desktop width','framework'); ?> </span>
       <?php $mb->the_field('ad_rsponsive_width'); ?>
        <input type="text" id="<?php $mb->the_name(); ?>" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>" class="custom_input">
    </div>
</div> <!--mti_options-->
        </div> <!--input-->
