 ...
 * @version   2.5.2 for parent theme Momizat Theme for publication on ThemeForest
		...
		protected function do_plugin_install() {
			...
			if ( ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' === $_GET['tgmpa-install'] ) || ( isset( $_GET['tgmpa-update'] ) && 'update-plugin' === $_GET['tgmpa-update'] ) ) {
				...
				if ( $this->is_tgmpa_complete() ) {
					...
					// Momizat
					echo '<p><a href="', esc_url( admin_url( 'admin.php?page=momizat-plugins' ) ), '" target="_parent">', esc_html( $this->strings['return'] ), '</a></p>';
				...
				if ( current_user_can( 'install_plugins' ) ) {
					if ( $install_link_count > 0 ) {
						$action_links['install'] = sprintf(
							...
							//Momizat change link
							admin_url( 'admin.php?page=momizat-plugins' )						);
					}
