...
function breadcrumbs_plus_get_bbpress_items( $args = array() ) {
	...
	if ( bbp_is_forum_archive()) {
		...
		$item[] = '<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" href="'. get_post_type_archive_link( bbp_get_forum_post_type() ) .'" class="home"><span itemprop="title">' . bbp_get_forum_archive_title() . '</span></a></span>';
