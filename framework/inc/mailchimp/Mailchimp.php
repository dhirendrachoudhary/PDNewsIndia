...
class Mom_Mailchimp {
    ...
    public static $error_map = array(
        ...
        "Goal_SaveFailed" => "Mom_Mailchimp_Goal_SaveFailed",
        "Conversation_DoesNotExist" => "Mom_Mailchimp_Conversation_DoesNotExist",
        "Conversation_ReplySaveFailed" => "Mom_Mailchimp_Conversation_ReplySaveFailed",
        "File_Not_Found_Exception" => "Mom_Mailchimp_File_Not_Found_Exception",
        "Folder_Not_Found_Exception" => "Mom_Mailchimp_Folder_Not_Found_Exception",
        "Folder_Exists_Exception" => "Mom_Mailchimp_Folder_Exists_Exception"
    );
    ...
    public function __construct($apikey=null, $opts=array()) {
        ...
        if (!$apikey) {
            throw new Mom_Mailchimp_Error('You must provide a MailChimp API key');
        }
        ...
        $this->conversations = new Mom_Mailchimp_Conversations($this);
        ...
        $this->goal = new Mom_Mailchimp_Goal($this);
    }
    ...
    public function castError($result) {
        if ($result['status'] !== 'error' || !$result['name']) {
            throw new Mom_Mailchimp_Error('We received an unexpected error: ' . json_encode($result));
        }

        $class = (isset(self::$error_map[$result['name']])) ? self::$error_map[$result['name']] : 'Mom_Mailchimp_Error';
