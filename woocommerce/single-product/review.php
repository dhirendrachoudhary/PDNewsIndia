...
?>
<li itemprop="reviews" itemscope itemtype="http://schema.org/Review" <?php comment_class('single-comment'); ?> id="li-comment-<?php comment_ID() ?>">

	<div id="comment-<?php comment_ID(); ?>" class="comment-wrap base-box woo-comment">
